<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>CSM</b>P</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="{{ asset('assets/dist/img/logofxx.png') }}" style="max-width:170px;max-height:300px;margin-top:-15px;"/></span>
    </a>
